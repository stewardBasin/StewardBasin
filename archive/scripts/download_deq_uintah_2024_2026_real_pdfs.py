...
LINKS_FILE = BASE_DIR / "data" / "deq_uintah_2024_2026_pdf_links.txt"
OUTPUT_DIR = BASE_DIR / "pdfs" / "deq_uintah_2024_2026_real"
...
def main():
    ...
    for index, old_url in enumerate(links, start=1):
        ...
        output_path = OUTPUT_DIR / f"deq_uintah_2024_2026_{index:03d}_{record_id}.pdf"
