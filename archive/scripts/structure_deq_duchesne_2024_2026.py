...
RAW_FILE = os.path.join(BASE_DIR, "data", "deq_duchesne_2024_2026_raw.json")
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "deq_duchesne_2024_2026_structured.json")
...
def classify_incident(title, summary, chemicals):
    ...
    if "diesel" in blob or "gasoline" in blob or "fuel" in blob:
        return "Fuel Release"
...
for raw in raw_records:
    ...
    lng, lat = parse_lon_lat(lon_lat_raw)
    ...
    record = {
        ...
        "enviroappsymbol": "n/a",
        "county": clean_spaces(county) or "DUCHESNE",
        ...
        # Extra fields for our Steward Basin review/use
...
print()
print("======================================")
print("DEQ DUCHESNE STRUCTURED JSON CREATED")
print("======================================")
